            ...
            <div class="text-center mb-16 fade-in-on-scroll">
                ...
                <div class="relative inline-block mb-6">
                    ...
                    <div class="relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm px-8 md:px-12 py-4 md:py-6 rounded-2xl border border-islamic-green-400/30 shadow-2xl">
                        ...
                        <h2 class="text-4xl md:text-5xl font-bold text-white mb-0 relative z-10 drop-shadow-lg">
                            <?php echo e(__('messages.pricing_title')); ?>

                        </h2>
                    </div>
                </div>
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                    <?php echo e(__('messages.pricing_subtitle')); ?>
                    ...
                    <div class="relative bg-gradient-to-br from-gray-800/95 to-gray-700/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-600/50 hover:border-islamic-green-500/50 transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col">
                        ...
                        <div class="relative bg-gradient-to-br from-islamic-green-600/30 to-islamic-green-700/30 p-6 border-b border-gray-600/50">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-xs font-semibold text-islamic-green-400 uppercase tracking-wider"><?php echo e(__('messages.pricing_package_1')); ?></span>
                                ...
                                <h3 class="text-2xl font-bold text-white mb-1"><?php echo e(__('messages.pricing_package_1_name')); ?></h3>
                                <p class="text-sm text-gray-300"><?php echo e(__('messages.pricing_package_1_desc')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-b border-gray-600/50">
                            <div class="flex items-baseline gap-2 mb-2">
                                ...
                                <span class="text-gray-400 text-sm"><?php echo e(__('messages.pricing_per_month')); ?></span>
                            </div>
                            <div class="flex items-center gap-2">
                                ...
                                <span class="px-2 py-1 bg-islamic-green-500/20 text-islamic-green-400 text-xs font-semibold rounded-full">
                                    ✨ <?php echo e(__('messages.pricing_package_1_save')); ?>
                        ...
                        <div class="p-6 flex-grow">
                            <ul class="space-y-4">
                                <li class="flex items-start gap-3">
                                    ...
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_1_feature_1')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_1_feature_2')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_1_feature_3')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_1_feature_4')); ?></span>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="fade-in-on-scroll relative group">
                    ...
                    <div class="absolute -top-4 left-1/2 -translate-x-1/2 z-20">
                        <div class="bg-gradient-to-r from-islamic-teal-500 to-islamic-green-500 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2">
                            ...
                            <span><?php echo e(__('messages.pricing_most_popular')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="relative bg-gradient-to-br from-gray-800/95 to-gray-700/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border-2 border-islamic-teal-500/50 hover:border-islamic-teal-400 transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col">
                        ...
                        <div class="relative bg-gradient-to-br from-islamic-teal-600/40 to-islamic-green-600/40 p-6 border-b border-gray-600/50 pt-10">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-xs font-semibold text-islamic-teal-400 uppercase tracking-wider"><?php echo e(__('messages.pricing_package_2')); ?></span>
                                ...
                                <h3 class="text-2xl font-bold text-white mb-1"><?php echo e(__('messages.pricing_package_2_name')); ?></h3>
                                <p class="text-sm text-gray-300"><?php echo e(__('messages.pricing_package_2_desc')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-b border-gray-600/50">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="px-2 py-1 bg-islamic-teal-500/20 text-islamic-teal-400 text-xs font-semibold rounded-full">
                                    ✨ <?php echo e(__('messages.pricing_package_2_save')); ?>
                        ...
                        <div class="p-6 flex-grow">
                            <ul class="space-y-4">
                                <li class="flex items-start gap-3">
                                    ...
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_2_feature_1')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-teal-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_2_feature_2')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-teal-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_2_feature_3')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-teal-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_2_feature_4')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-teal-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_2_feature_5')); ?></span>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="fade-in-on-scroll relative group">
                    ...
                    <div class="relative bg-gradient-to-br from-gray-800/95 to-gray-700/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-600/50 hover:border-islamic-gold-500/50 transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col">
                        ...
                        <div class="relative bg-gradient-to-br from-islamic-gold-600/30 to-islamic-green-600/30 p-6 border-b border-gray-600/50">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-xs font-semibold text-islamic-gold-400 uppercase tracking-wider"><?php echo e(__('messages.pricing_package_3')); ?></span>
                                ...
                                <h3 class="text-2xl font-bold text-white mb-1"><?php echo e(__('messages.pricing_package_3_name')); ?></h3>
                                <p class="text-sm text-gray-300"><?php echo e(__('messages.pricing_package_3_desc')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-b border-gray-600/50">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="px-2 py-1 bg-islamic-gold-500/20 text-islamic-gold-400 text-xs font-semibold rounded-full">
                                    ✨ <?php echo e(__('messages.pricing_package_3_save')); ?>
                        ...
                        <div class="p-6 flex-grow">
                            <ul class="space-y-4">
                                <li class="flex items-start gap-3">
                                    ...
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_3_feature_1')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-gold-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_3_feature_2')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-gold-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_3_feature_3')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-gold-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_3_feature_4')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-gold-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_3_feature_5')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-gold-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_3_feature_6')); ?></span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-islamic-gold-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-300"><?php echo e(__('messages.pricing_package_3_feature_7')); ?></span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="fade-in-on-scroll mt-16">
                <div class="text-center mb-8">
                    <h3 class="text-2xl md:text-3xl font-bold text-white mb-3">
                        💚 <?php echo e(__('messages.pricing_addons_title')); ?>

                    </h3>
                    <p class="text-gray-300 max-w-2xl mx-auto">
                        <?php echo e(__('messages.pricing_addons_subtitle')); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                    ...
                    <div class="bg-gradient-to-br from-gray-800/80 to-gray-700/80 backdrop-blur-sm p-6 rounded-2xl border border-gray-600/50 hover:border-islamic-green-500/50 transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h4 class="text-xl font-bold text-white"><?php echo e(__('messages.pricing_addon_family')); ?></h4>
                        </div>
                        <p class="text-gray-300 mb-4"><?php echo e(__('messages.pricing_addon_family_desc')); ?></p>
                        <div class="flex items-center gap-2">
                    ...
                    <div class="bg-gradient-to-br from-gray-800/80 to-gray-700/80 backdrop-blur-sm p-6 rounded-2xl border border-gray-600/50 hover:border-islamic-teal-500/50 transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h4 class="text-xl font-bold text-white"><?php echo e(__('messages.pricing_addon_3month')); ?></h4>
                        </div>
                        <p class="text-gray-300 mb-4"><?php echo e(__('messages.pricing_addon_3month_desc')); ?></p>
                        <div class="flex items-center gap-2">
                    ...
                    <div class="bg-gradient-to-br from-gray-800/80 to-gray-700/80 backdrop-blur-sm p-6 rounded-2xl border border-gray-600/50 hover:border-islamic-gold-500/50 transition-all duration-300 transform hover:-translate-y-1">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h4 class="text-xl font-bold text-white"><?php echo e(__('messages.pricing_addon_6month')); ?></h4>
                        </div>
                        <p class="text-gray-300 mb-4"><?php echo e(__('messages.pricing_addon_6month_desc')); ?></p>
                        <div class="flex items-center gap-2">
            ...
            <div class="text-center mb-12 fade-in-on-scroll">
                ...
                <div class="relative inline-block mb-6">
                    ...
                    <div class="relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm px-8 md:px-12 py-4 md:py-6 rounded-2xl border border-islamic-teal-400/30 shadow-2xl">
                        ...
                        <h2 class="text-4xl md:text-5xl font-bold text-white mb-0 relative z-10 drop-shadow-lg">
                            <?php echo e(app()->getLocale() === 'ar' ? 'مقال مميز' : 'Featured Article'); ?>
            ...
            <div class="fade-in-on-scroll">
                ...
                <article class="bg-gradient-to-br from-gray-800/90 to-gray-700/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-600/50 hover:border-islamic-green-500/50 transition-all duration-300 group">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                        ...
                        <a href="<?php echo e($featuredPostUrl); ?>" class="relative h-64 lg:h-auto overflow-hidden bg-gradient-to-br from-islamic-green-500/20 to-islamic-teal-500/20 block cursor-pointer">
                            <?php if($featuredPost->featured_image): ?>
                                <img src="<?php echo e(asset($featuredPost->featured_image)); ?>" 
                        ...
                        <div class="p-8 md:p-12 flex flex-col justify-center">
                            ...
                            <div class="flex items-center gap-4 mb-4 text-sm text-gray-400">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-white font-medium"><?php echo e($featuredPost->author_name); ?></span>
                                </div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <time><?php echo e($featuredPost->formatted_published_date); ?></time>
                                </div>
                            </div>
                            
                            <!-- Title - Clickable -->
                            <a href="<?php echo e($featuredPostUrl); ?>" class="block mb-4">
                            ...
                            <!-- Excerpt - Clickable -->
                            <a href="<?php echo e($featuredPostUrl); ?>" class="block mb-6 cursor-pointer">
                            ...
                            <div class="flex items-center gap-4">
                                <a href="<?php echo e($featuredPostUrl); ?>" 
                                   class="btn-primary inline-flex items-center gap-2">
                                    <span><?php echo e(app()->getLocale() === 'ar' ? 'اقرأ المقال كاملاً' : 'Read Full Article'); ?></span>
                                ...
                                <a href="<?php echo e(route('blog.index', ['locale' => app()->getLocale()])); ?>" 
                                   class="text-gray-300 hover:text-islamic-teal-400 transition-colors font-semibold">
                                    <?php echo e(app()->getLocale() === 'ar' ? 'عرض جميع المقالات' : 'View All Articles'); ?>
